 ...
 * </p>
 * <ul>
 *   <li>{@link lab1.impl.KPIImpl#getId <em>Id</em>}</li>
 *   <li>{@link lab1.impl.KPIImpl#getTransformation <em>Transformation</em>}</li>
 *   <li>{@link lab1.impl.KPIImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KPIImpl extends MinimalEObjectImpl.Container implements KPI {
	...
	protected EClass eStaticClass() {
		return Lab1Package.Literals.KPI;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lab1Package.KPI__ID, oldId, id));
	}
	...
	public EList<Transformation> getTransformation() {
		if (transformation == null) {
			transformation = new EObjectContainmentEList<Transformation>(Transformation.class, this,
					Lab1Package.KPI__TRANSFORMATION);
		}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lab1Package.KPI__NAME, oldName, name));
	}
	 ...
	 * @generated
	 */
	public void calculate(MonthsBudgetList budgetValues) {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Lab1Package.KPI__TRANSFORMATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Lab1Package.KPI__ID:
			return getId();
		case Lab1Package.KPI__TRANSFORMATION:
			return getTransformation();
		case Lab1Package.KPI__NAME:
			return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case Lab1Package.KPI___CALCULATE__MONTHSBUDGETLIST:
			calculate((MonthsBudgetList) arguments.get(0));
			return null;
		}
